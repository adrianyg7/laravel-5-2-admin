...
},{"./helpers":7,"admin-lte":1,"bootstrap-sass":2,"fastclick":3,"icheck":4,"jquery":5}],7:[function(require,module,exports){
'use strict';
...
},{"./helpers/data-tables":8,"./helpers/delete-swal":9,"./helpers/flash-messaging":10,"./helpers/i-check":11,"./helpers/required-fields":12,"./helpers/select2":13}],8:[function(require,module,exports){
'use strict';
...
module.exports = function () {
    ...
    $(':input[required]').closest('.form-group').children('label').append(' <span class="required">*</span>');
};
